...
require (
	...
	github.com/open-telemetry/opentelemetry-lambda/collector/lambdacomponents v0.0.0-00010101000000-000000000000
...
require (
	...
	github.com/open-telemetry/opentelemetry-collector-contrib v0.60.0 // indirect
